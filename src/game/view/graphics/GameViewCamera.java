...
public class GameViewCamera {
    ...
    public void centerOnGameObject(GameObject gameObject){
        ...
        // without (+ half of the gameObject) we will be centered around the top left corner of the gameObjects collisionBox
    ...
    /**
     * Check to see if the camera offset will not cause any blank space outside the game world to show
     */
    private void checkWorldEdges(){
        ...
        if(xOffset > 20 * GameView.DEFAULT_TILEWIDTH - GameView.DEFAULT_WIDTH){
            xOffset = 20 * GameView.DEFAULT_TILEWIDTH - GameView.DEFAULT_WIDTH;
        }
        ...
        if(yOffset > 20 * GameView.DEFAULT_TILEHEIGHT - GameView.DEFAULT_HEIGHT){
            yOffset = 20 * GameView.DEFAULT_TILEHEIGHT - GameView.DEFAULT_HEIGHT;
        }
    }
