 ...
 * @author Joren
 */
public class DoorToMasterBedroom extends StaticGameObject{
    
    //Variables
    private Item requiredItem = new Item("Master bedroom key", 9);
     ...
     * @param message 
     */
    public DoorToMasterBedroom(Game game, double x, double y, String message) {
